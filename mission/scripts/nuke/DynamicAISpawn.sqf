/////////////////////////////////////////////////////////////////////
//
//   Author : Lt.Killer(SAS) and Cpt.Killer(SAS)
//   Edited  for ARMA3 EPOCH by W4lly63   30-06-15
//   version mod for NUKE-MISSION-MOD
////////////////////////////////////////////////////////////////////
...
_group0 = Creategroup RESISTANCE;  _group0 setBehaviour "COMBAT"; _group0 setCombatMode "RED";
_group1 = Creategroup RESISTANCE;  _group1 setBehaviour "COMBAT"; _group1 setCombatMode "RED";
_group2 = Creategroup RESISTANCE;  _group2 setBehaviour "COMBAT"; _group2 setCombatMode "RED";
_group3 = Creategroup RESISTANCE;  _group3 setBehaviour "COMBAT"; _group3 setCombatMode "RED";
_group4 = Creategroup RESISTANCE;  _group4 setBehaviour "COMBAT"; _group4 setCombatMode "RED";
_group5 = Creategroup RESISTANCE;  _group5 setBehaviour "COMBAT"; _group5 setCombatMode "RED";
_group6 = Creategroup RESISTANCE;  _group6 setBehaviour "COMBAT"; _group6 setCombatMode "RED";
_group7 = Creategroup RESISTANCE;  _group7 setBehaviour "COMBAT"; _group7 setCombatMode "RED";
...
_man_type=["O_Soldier_F","O_officer_F","O_Soldier_GL_F","O_G_Soldier_TL_F","O_G_Soldier_AR_F"];
...
//  _group_spawn_delay_max=[60,60,60,80,65,60];
//
...
_sleep_delay = 20;						// This MUST be at lRESISTANCE two times less than any of the _group_spawn_delay numbers
...
_skill_odds=[20, 50, 50, 70, 100, 90, 90, 80];		// Must contain the same number of entries as _group_skill
...
if (isNil "inRadiationZone") then {
	...
	{
	    waitUntil {
        ((alive player) && (time > 0) && inRadiationZone)
    };
